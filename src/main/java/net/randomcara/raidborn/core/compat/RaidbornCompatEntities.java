...
public class RaidbornCompatEntities {
    ...
    private static final Set<ResourceLocation> IINV_CASTERS = Set.of(IINV_SORCERER, IINV_ARCHIVIST, IINV_NECROMANCER, IINV_INVOKER, IINV_FIRECALLER);

    private static final Set<ResourceLocation> SANDR_CASTERS = Set.of(SANDR_ICEOLOGER, SANDR_TRICKSTER);
    ...
    public static boolean fleesFromPlayers(Entity entity) {
        ...
        return (iinvLoaded() && IINV_CASTERS.contains(id)) || (sandrLoaded() && SANDR_CASTERS.contains(id));
    }
}
