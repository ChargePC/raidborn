...
public class RecruitOwnership {
    public static boolean isRecruited(Mob mob) {
        return mob.getPersistentData().getBoolean(FollowOwnerGoal.TAG_RECRUITED) && mob.getPersistentData().hasUUID(FollowOwnerGoal.TAG_OWNER);
    }

    public static UUID getOwnerUUID(Mob mob) {
        return mob.getPersistentData().hasUUID(FollowOwnerGoal.TAG_OWNER) ? mob.getPersistentData().getUUID(FollowOwnerGoal.TAG_OWNER) : null;
    }
    ...
    public static boolean isSameSquad(Mob a, Mob b) {
        ...
        return ownerA != null && ownerB != null && ownerA.equals(ownerB) && isRecruited(a) && isRecruited(b);
    }
}
