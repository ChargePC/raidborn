...
public class IronGolletModel<T extends IronGollet> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild(
                "left_arm",
                CubeListBuilder.create().texOffs(50, 19).addBox(-1.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.025F)).texOffs(32, 36).mirror().addBox(-1.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
                PartPose.offset(8.6F, 11.0F, -1.5F)
        );

        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create() .texOffs(46, 0) .addBox(-3.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.025F)) .texOffs(32, 36) .addBox(-3.0F, -2.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.4F, 11.0F, -1.5F));

        PartDefinition head = partdefinition.addOrReplaceChild(
                "head",
                CubeListBuilder.create().texOffs(0, 51).addBox(-1.0F, -1.975F, -6.05F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 36).addBox(-4.0F, -5.975F, -4.05F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(50, 47).addBox(-4.0F, -17.975F, -0.05F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 11.975F, -2.95F)
        );

        head.addOrReplaceChild("cube_r1", CubeListBuilder.create() .texOffs(50, 47) .addBox(-4.0F, -6.0F, 0.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.975F, -0.05F, 0.0F, -1.5708F, 0.0F));

        partdefinition.addOrReplaceChild("body", CubeListBuilder.create() .texOffs(0, 0) .addBox(-7.4F, -8.0F, -4.0F, 15.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)) .texOffs(0, 18) .addBox(-7.4F, -8.0F, -4.0F, 15.0F, 10.0F, 8.0F, new CubeDeformation(0.025F)), PartPose.offset(0.0F, 18.0F, -1.0F));

        partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create() .texOffs(50, 38) .addBox(-2.5F, 0.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.5F, 20.0F, -0.5F));

        partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create() .texOffs(50, 38) .addBox(-2.5F, 0.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(3.5F, 20.0F, -0.5F));
