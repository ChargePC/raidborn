...
public class ArtifactHudOverlay {
    private static final ResourceLocation ARTIFACT_SLOT_TEXTURE = Raidborn.id("textures/gui/sprites/hud/artifact_slot.png");
    ...
    public static final IGuiOverlay OVERLAY = (gui, guiGraphics, partialTick, screenWidth, screenHeight) -> {
        ...
        if (!RaidbornClientConfig.showArtifactHud() || mc.options.hideGui || mc.player == null || mc.player.isSpectator()) {
            return;
        }
