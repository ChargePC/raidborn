...
public class RaidbornNecklaceEffectEvents {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (event.phase != TickEvent.Phase.END || event.player.level().isClientSide || !(event.player instanceof ServerPlayer player) || player.isDeadOrDying()) {
            return;
        }
    ...
    private static class SavedAllianceEffect {
        ...
        private SavedAllianceEffect(String effectId, int duration, int amplifier, boolean ambient, boolean visible, boolean showIcon) {
        ...
        private static SavedAllianceEffect captureEffect(ServerPlayer player, MobEffect effect) {
            ...
            return new SavedAllianceEffect(effectId.toString(), duration, instance.getAmplifier(), instance.isAmbient(), instance.isVisible(), instance.showIcon());
        }
        ...
        private static SavedAllianceEffect load(CompoundTag tag) {
            ...
            return new SavedAllianceEffect(effectId, duration, amplifier, ambient, visible, showIcon);
        }
