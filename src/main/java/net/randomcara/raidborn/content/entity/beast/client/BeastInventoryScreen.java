...
public class BeastInventoryScreen extends AbstractContainerScreen<BeastInventoryMenu> {
    private static final ResourceLocation GUI_TEXTURE = ResourceLocation.fromNamespaceAndPath(Raidborn.MOD_ID, "textures/gui/beast_inventory.png");
    ...
    public BeastInventoryScreen(BeastInventoryMenu menu, Inventory inventory, Component title) {
    ...
    private void renderBeast(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.enableScissor(areaLeft, areaTop, areaRight, areaBottom);

        InventoryScreen.renderEntityInInventoryFollowsMouse(guiGraphics, renderX, renderY, BEAST_RENDER_SCALE, mouseOffsetX, mouseOffsetY, beast);
